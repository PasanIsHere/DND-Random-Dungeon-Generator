...
public class Level {
    private HashMap<Chamber,ArrayList<Door>> chamberDoorMap;
    private HashMap<Door, Door> doorConnections;
    private ArrayList<Chamber> chamberList = new ArrayList<>();
    private ArrayList<Passage> passageList = new ArrayList<>();
     ...
     * @return string
     */
    public String getTarget(int i, int j) {
